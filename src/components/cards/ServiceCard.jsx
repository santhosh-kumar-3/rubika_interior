...
const ServiceCard = ({ title, description, image }) => {
  return (
    <div>
      <div className="hidden lg:block group w-[580px] h-[380px] font-robotoCondensed rounded-sm overflow-hidden cursor-pointer transform transition-transform duration-500 ">
      <div
