...
const Hero = () => {
  ...
  return (
    <div className="h-[80vh] md:h-[97vh] w-full font-robotoCondensed relative">
      ...
      {/* Content */}
      <div className="w-full h-full flex flex-col justify-center pl-6 md:pl-12 lg:pl-36 pt-24 relative z-10">
